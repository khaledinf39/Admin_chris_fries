 ...
 */
public class complete_Allrequest extends Fragment {


    public complete_Allrequest() {
...
RecyclerView list;
    ...
    public AllOdrer_activity.Onfilter onfilterListenner;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       final View view= inflater.inflate(R.layout.fragment_compte_request, container, false);
        ...
        reference=database.getReference("Requests").child(Const.complete);
    ...
    private void FilterByDate(String date_in, String date_to) {
        ...
        Date datein = null,dateto=null;
        try {
          datein  = sdf.parse(date_in);
        ...
        for (Request rqs:requestListFilter
            ...
            try {
                ...
                Log.d("date",date.toString()+"   ..."+datein.toString()+"  ----"+dateto.toString());
